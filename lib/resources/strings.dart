abstract class AppStrings {
  ...
  static const String delivered = "ارسال شده";
  static const String continueShopping = "ادامه فرآیند خرید";
  static const List<String> tabList = ["نظرات", "نقد و بررسی", "خصوصیات"];
